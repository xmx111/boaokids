  ...
  if( typeof define === "function" && define.amd ){
	...
	$(document).ready(function() {
	    ...
	    var init_video_teaser = function () {   
	    	...
	    	var xml = $.ajax({
	    		url: 'http://pbskids.org/video/data/pbsKidsVideo.xml',
        ...
        function init() {
            ...
            var assetsPath = "/audio/SoundClips/Home/";
            var sounds = [
                {src: "games.mp3", id: "games"},
                {src: "pbsKids.mp3", id: "pbsKids"},
                {src: "video.mp3", id: "videos"},
                {src: "newGames.mp3", id: "newGames"},
                {src: "popularGames.mp3", id: "popularGames"},
                {src: "hardGames.mp3", id: "hardGames"},
                {src: "allGames.mp3", id: "allGames"},
                {src: "writersContest.mp3", id: "writersContestBadge"},
                {src: "hooper.mp3", id: "hooperBadge"},
                {src: "cartoonStudio.mp3", id: "cartoonStudioBadge"},
                {src: "fetch.mp3", id: "ruffRuffmanBadge"}
            ];
