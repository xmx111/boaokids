  ...
  *****************************/
  ...
  function buildNewsletterSignup(){
    ...
    var __onStationSelected = function(e){
      ...
      $('.parents-tooltip.newsletter-signup .pbskids-insider-signup-station-logo').html('<img src="http://www-tc.pbs.org/images/stations/standard/' + e.station.callLetters + '.gif"/>' + e.station.commonName);
    ...
    var newsLetterContent = '<h3>Sign up for newsletter</h3>'
                          ...
                          +       (org.pbskids.localization.station ? '<img src="http://www-tc.pbs.org/images/stations/standard/' + org.pbskids.localization.station.callLetters + '.gif"/>' + org.pbskids.localization.station.commonName : '')
                          +     '</span>'
  ...
  function buildParentsInfoTooltip() {
      ...
      var _tipContent   = "<h3>Check out these sites for parents of PBS KIDS</h3>" +
                          "<ul class='stack-list content-col narrow'>" +
                            "<li><a href='http://www.pbslearningmedia.org/' class='not-bridge parents-flag-link learningmedia' title='PBS Learning Media'></a>" +
                              "<em>Classroom-ready, digital resources for teachers</em> </li>" +
                            "<li><a href='http://pbskids.org/lab'           class='not-bridge parents-flag-link pbskidslab'    title='PBS KIDS Lab'></a>" +
                              "<em>All the new games &amp; technologies we're working on</em></li>" +
                            // Galen: removed link bellow
                          ...
                          "<figure class='feature content-col wide'>" +
                            "<a href='http://www.pbs.org/parents/' class='not-bridge parents-flag-link pbsparents' title='PBS Parents'>" +
                              "<img alt='' src='" + _parentsLogo + "' />" +
                            "</a>" +
                            "<figcaption>" +
                              "<p>Parenting resources and tips on raising children, planning birthday parties &amp; kids activities.</p>" +
                              "<a href='http://www.pbs.org/parents/' class='not-bridge parents-flag-link button' title='PBS Parents'>VISIT PBS PARENTS</a>" +
                            "</figcaption>" +
                          "</figure>" +
                          "<footer>" +
                            "Clicking these links will leave PBS KIDS for a trusted site." +
                            "<em class='fineprint'><a href='http://pbskids.org/privacy/'>Privacy Policy</a> | <a href='http://pbskids.org/privacy/termsofuse.html'>Terms of Use</a> | pbskids.org &copy; 1995-2015</em>" +
                          "</footer>";
