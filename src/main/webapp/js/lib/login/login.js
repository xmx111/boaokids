  ...
  (function( require, define, factory ){
     ...
     */
      ...
      if (username && userid){
        loginClass.user = {
          id     : userid,
          name   : username,
          avatar : 'http://www-tc.pbskids.org/go/secretbox/images/avatars/' + ( _getCookie('pbskids.avatar') || 'trophy' ) + '.jpg',
    ...
    function initPublicMethods(){
      ...
      loginClass.displayLogin = function( queryData, url ){
        var closeButtonImageURL = "http://www-tc.pbskids.org/includes/auth/images/close.gif";
